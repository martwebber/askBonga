...
<div class="cspacer">
	...
	<div align="center" style="text-align:left; width:100%">
        ...
        <br />
        <form name='registrations' action='query_registration_details_2014.php' method='post'>
        <center>
        ...
        ?>
			...
			<?php
				...
				$columns = array("MSISDN","ID_NUMBER","AREA_CODE","to_char(REGISTRATION_DATE,'dd-Mon-yyyy hh24:mi')","RETAILER_NAME");
                $titles = array("MSISDN","ID Number","Area Code","Registration Date","Retailer Name");

...
<div class="cspacer">
		...
		<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Shangwe Mtaani 2015 Participant Points Accumulation</p>
        <br />
		
		<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:10px; color:#FF3300; padding: 5px;">NOTE:To get Total points awarded, add 100 points for Registration and/or 1000 Entries for every 10,000 threshold entries reached e.g. at reaching 10,000, 20,000 and so on.	 </p>
        <br />
  
        <form name='points_list' action='check_shangwe_subs_points_2015.php' method='post'>
        <center>
        ...
        ?>
                        ...
                        <?php
								...
								$tables = array("vw_bo15_subs_points");
                                $columns = array("date_asked","date_answered","qns_id","question","correct_answer","subs_answer","points","cummulative");
								$titles = array("date_asked","date_answered","qns","question","ans","subs_ans","remarks","cumulative");

...
<div class="cspacer">
	...
	<div align="center" style="text-align:left; width:100%">
		<!--<table class="tablebody border" width="100%">
		 ...
		 <br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Clear Blacklist Details</p>
        <br />
        <form name='clear_blacklist' action='clear_mauzo_blacklist.php' method='post'>
        <center>
        ...
        ?>
			...
			<?php
				...
				$query = "DELETE FROM tbl_blacklist WHERE substr(msisdn,4,9) = '".substr($_POST['msisdn'],-9)."'";
				$db->generic_sql($query);
				logmessage("INFO", "CLEAR MAUZO BLACKLIST for Msisdn - ".$_POST['msisdn']." deleted by User: ".$_SESSION['USERID']);
				$display_str = "Blacklist lifted for Msisdn - ".$_POST['msisdn'];
				echo "<br><p class='error'>".$display_str."</p><br>";

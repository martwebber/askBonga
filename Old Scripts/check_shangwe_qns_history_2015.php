...
<div class="cspacer">
		...
		<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Shangwe Mtaani 2015 Participant Questions History</p>
        <br />
  
        <form name='points_list' action='check_shangwe_qns_history_2015.php' method='post'>
        <center>

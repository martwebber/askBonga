...
<br />
        ...
        <br />
        <form name='airtime_serial' action='mauzo_2015_query_airtime_serial.php' method='post'>
        <center>
        ...
        ?>
			...
			<?php
				...
				/*$tables = array("tbl_mz15_airtime_pins");
				...
				$tables = array("tbl_mz15_airtime_pins");
				$columns = array("serial_number","decode(status,0,'Not Redeemed',1,'Redeemed','Unknown')","msisdn","denomination","DECODE(TO_CHAR(DATE_SENT,'DD-MON-YY'),'08-JUN-2015','Draw 1','22-JUN-15','Draw 2','06-JUL-15','Draw 3','20-JUL-15','Draw 4','Unknown')");
                $titles = array("Airtime Serial", "STATUS","MSISDN", "DENOMINATION","Draw");
                $advanced = "where substr(msisdn,-9) = ".substr($_POST['msisdn'],-9)."  order by 1 asc";
				$display_str = $db->display_records($tables, $columns, $titles, "airtime_serial", $advanced, null, null, "");

...
<div class="cspacer">
		...
		<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Shangwe Mtaani 2015 Participant Winnings</p>
        <br />
  
        <form name='winnings_list' action='check_shangwe_winnings_2015.php' method='post'>
        <center>
        ...
        ?>
                        ...
                        <?php
							$tables = array("VW_BO15_WINNERS");
							$columns = array("msisdn","region_name", "prize_name", "to_char(win_date, 'dd-MON-yyyy hh24:mi')","Award_Status","Award_Date", "MPESA_TRX_ID");
                $titles = array("MSISDN","Win Region", "Prize", "Date Won","Award Status","Award Date","MPESA_TRX_ID");

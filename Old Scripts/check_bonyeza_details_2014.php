...
<div class="cspacer">
		...
		<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Bonyeza 2014 Participant Details</p>
        <br />
  
        <form name='points_list' action='check_bonyeza_details_2014.php' method='post'>
        <center>

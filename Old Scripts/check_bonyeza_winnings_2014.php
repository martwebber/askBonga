...
<div class="cspacer">
		...
		<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Bonyeza 2014 Participant Winnings</p>
        <br />
  
        <form name='winnings_list' action='check_bonyeza_winnings_2014.php' method='post'>
        <center>

...
"mpesa_statements_deactivate_sub.php","mpesa_statements_check_sub_registration.php","mpesa_statements_resend_statement.php",
"advantage_plus_status_query.php","mpesa_statements_check_sub_requests.php","mpesa_statements_check_sub_activity.php","redcross_promotion.php","happyhour_query_whitelist.php","showmax_promotion.php");

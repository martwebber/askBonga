...
<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">DHL Lipa Na M-PESA Airtime Awards</p>
        <br />
        <form name='dhl_winner' action='lnm_dhl_query_airtime_status.php' method='post'>
        <center>
        ...
        ?>
			...
			<?php
$tables = array("TBL_DHL_AIRTIME_AWARD");

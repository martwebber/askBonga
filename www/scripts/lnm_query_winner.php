...
<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Lipa Na MPESA with Uchumi Promo Winner Details</p>
        <br />
        <form name='winner' action='lnm_query_winner.php' method='post'>
        <center>

...
<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Retailer Winner Details</p>
        <br />
        <form name='winner' action='query_winner.php' method='post'>
        <center>
        ...
        ?>
			...
			<?php
$tables = array("v_winners");
				$columns = array("msisdn","confirm_winner","draw_no","draw_date","prize_name");
                $titles = array("msisdn", "Confirmed Status", "draw_no","Win Date", "Prize");

<?php
    ...
    $BONGA_DATABASEHOST = "172.29.226.19";
    $BONGA_DATABASEPORT = "1521";
    $BONGA_DATABASEUSER = "promo";
    $BONGA_DATABASEPASSWORD = "pr0m0#123";
    $BONGA_DATABASENAME = "WEBSCDB";
...
<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Web Selfcare Promo Winners</p>
        <br />
        <form name='wsc_promo_winners' action='selfcare_winners.php' method='post'>
        <center>
        ...
        ?>
			...
			<?php
$tables = array("wsc_promo_winners");
				$columns = array("msisdn","winning_date","wsc_username","digits_guessed","award_rewarded","cbs_response");
                $titles = array("Msisdn", "TrxDate","Username","Digit Guessed","Amount","Airtime Status");
                $advanced = "where msisdn = '".substr($_POST['msisdn'],-9)."' order by id desc";
				$display_str = $db->display_records($tables, $columns, $titles, "wsc_promo_winners", $advanced, null, null, "");

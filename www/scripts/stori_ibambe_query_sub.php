...
<div class="cspacer">
		...
		<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Daily Bonus Promotion</p>
        <br />
  
        <form name='story_list' action='stori_ibambe_query_sub.php' method='post'>
        <center>
        ...
        ?>
                        ...
                        <?php
                                $tables = array("FCT_DAILY_UPSELL_ALL_CHNGE");
                                $columns = array("MSISDN", "CBS_PRODUCT", "CBS_DESC");
								$titles = array("MSISDN", "CBS Product", "Product Name");

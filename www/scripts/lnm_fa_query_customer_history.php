...
<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Lipa Fuel Na M-PESA, Interaction History</p>
        <br />
        <form name='bata_query_customer_history' action='lnm_fa_query_customer_history.php' method='post'>
        <center>
        ...
        ?>
			...
			<?php
$tables = array("vw_lnm_fa2_staging");
				$columns = array("msisdn","to_char(trx_date,'DD-MON-YYYY')","mpesa_trx_id","TRANSACTION_AMOUNT","Fuel_Station");
                $titles = array("msisdn", "TrxDate","Mpesa Trx","Amount","Store");

...
<br />
        ...
        <br />
        <form name='query_points' action='eol_cust_offer_history.php' method='post'>
        <center>
...
$tables = array("cvm_campaign.vw_eo_sub_offer_hist");
				...
				$titles = array("msisdn","offer_day","offer_load_date","offer_name","ussd_name");
                $advanced = "where substr(msisdn,-9) = ".substr($_POST['msisdn'],-9)." and ndc = ".substr($_POST['msisdn'],0,3)."";

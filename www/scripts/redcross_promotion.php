...
<div class="cspacer">
		...
		<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Red cross Promotion Details</p>
        <br />
  
        <form name='points_list' action='redcross_promotion.php' method='post'>
        <center>
        ...
        ?>
                ...
                $advanced = "where CUSTOMEMSISDN = ".substr($_POST['msisdn'],-9);

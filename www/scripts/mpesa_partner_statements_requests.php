...
<div class="cspacer">
		...
		<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">M-PESA Partner Statements - Query Requests</p>
        <br />
  
        <form name='points_list' action='mpesa_partner_statements_requests.php' method='post'>
        <center>
        ...
        ?>
                        ...
                        <?php
                                $tables = array("vw_statement_requests");
                                $columns = array("serial_no","msisdn", "short_code", "email_address","statement_type", "to_char(date_requested, 'dd-MON-yyyy hh24:mi')","statement_period","status");
								$titles = array("REQUEST_ID","MSISDN", "Store Number","E-mail Address", "Statement Type","Request Date", "Period","Status");

...
<br />
        ...
        <br />
        <form name='query_purchase_history' action='eo_cust_offer_purchase_history.php' method='post'>
        <center>
...
$tables = array("cvm_campaign.vw_eo_offer_request_history");
				$columns = array("msisdn","to_char(trx_date,'DD-MON-YYYY HH24:MI:SS')","offer_name","request_status","purchase_details","award_details","sms_sent");
                
				$titles = array("msisdn","date","offer","status","purchase_details","award_details","sms_sent");

    ...
    if (isset($_POST['msisdn'])) {
		...
		if ($error == "") {
			...
			if ($error == "") {
				...
				$query = "BEGIN MSTMT_RESEND_STATEMENT(:IN_MSISDN, :IN_SERIAL_NUMBER, :IN_SR_NUMBER, :IN_USER, :OUT_MESSAGE); END;";
				...
				logmessage("DEBUG", "Resend MSTMT_RESEND_STATEMENT: ".$in_msisdn."; $serial_number; ".$_POST['sr_number']."; ".$_SESSION['USERID']);
...
<div class="cspacer">
	...
	<div align="center" style="text-align:left; width:100%">
		<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">M-PESA Statements - Resend Statement</p>
        <br />
		...
		<form name='acc_history_list' action='mpesa_statements_resend_statement.php' method='post'>
		<center>

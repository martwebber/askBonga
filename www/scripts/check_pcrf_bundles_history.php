...
<div class="cspacer">
	...
	<div align="center" style="text-align:left; width:100%">
        ...
        <form name='acc_history_list' action='check_pcrf_bundles_history.php' method='post'>
        <center>
        ...
        ?>
			...
			<?php
                ...
                $advanced = "where a.bundle_id = b.bundle_id and msisdn = ".$_POST['msisdn']." order by request_date desc";

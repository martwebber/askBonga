<?php
    ...
    if (isset($_POST['msisdn'])) {
		...
		if ($error == "") {
			...
			$url="http://172.28.200.19:8080/bonga_reset/LMSReset?msisdn=".$msisdn."&sr_number=".$_POST['sr_number']."&user_id=".$_SESSION['USERID'];
			//$url = "http://10.5.96.103/bongapin/bonga_pin_gen.php?msisdn=".$msisdn."&user=bongapin&pass=pinbonga";
			...
			if (substr($newPin, 0, 2) == "-1" || !isset($newPin) || strlen($newPin) == 0) {
...
<div class="cspacer">
	...
	<div align="center" style="text-align:left; width:100%">
		...
		<form name='acc_history_list' action='reset_bonga_pin3.php' method='post'>
		<center>

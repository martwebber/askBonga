<?php
    ...
    $BONGA_DATABASEUSER = "nguruma";
    $BONGA_DATABASEPASSWORD = "nguruma123";
    ...
    if (isset($_POST['msisdn'])) {
		...
		if ($error == "") {
			...
			if ($error == "") {
				...
				$query = "BEGIN RESEND_AIRTIME_PIN(:IN_MSISDN); END;";
				$cursor = ocinewcursor($db->link);
				$stmt = ociparse ($db->link, $query);                                //bind variables
				$in_msisdn = $msisdn;
				$in_sr_number = "CM: ".$_POST['sr_number'];
	
				logmessage("DEBUG", "Resend nguruma airtime: ".$in_msisdn."; ".$_POST['sr_number']."; ".$_SESSION['USERID']);
...
<div class="cspacer">
	...
	<div align="center" style="text-align:left; width:100%">
		...
		<form name='acc_history_list' action='resend_nguruma_airtime.php' method='post'>
		<center>

...
<div class="cspacer">
	...
	<div align="center" style="text-align:left; width:100%">
        ...
        <form name='acc_history_list' action='check_pcrf_bundles_history_h.php' method='post'>
        <center>
        ...
        ?>
			...
			<?php
				...
				$tables = array("adhoc_account_history_h a, bundles_info b");
				...
				$columns = array("msisdn", "to_char(request_date, 'dd-MON-yyyy hh24:mi')", "to_char(provisioning_date, 'dd-MON-yyyy hh24:mi')", "description", "provisioning_comments");
                $titles = array("msisdn", "request_date", "processed_date", "bundle", "status");
                ...
                $advanced = "where a.bundle_id = b.bundle_id and msisdn = ".substr($_POST['msisdn'], -9)." order by request_date desc";
				$display_str = $db->display_records($tables, $columns, $titles, "acc_history_list", $advanced, null, null,  "acct_hist_id");

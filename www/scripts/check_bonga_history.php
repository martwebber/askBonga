...
<div class="cspacer">
	...
	<div align="center" style="text-align:left; width:100%">
        ...
        <form name='acc_history_list' action='check_bonga_history.php' method='post'>
        <center>
        ...
        ?>
			...
			<?php
				$tables = array("lms_requests l, request_codes r");
				$columns = array("to_char(trx_date, 'dd-MON-yyyy hh24:mi')", "a_party", "b_party", "description");
                $titles = array("request_date", "a_party", "b_party", "description");
                $advanced = "where l.out_result = r.code and a_party = ".substr($_POST['msisdn'],1)." order by trx_date desc";

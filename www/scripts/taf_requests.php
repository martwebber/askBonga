...
<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">M-Shwari Tell A Friend Requests</p>
        <br />
        <form name='taf_requests' action='taf_requests.php' method='post'>
        <center>
        ...
        ?>
			...
			<?php
$tables = array("tbl_taf_requests");
				$columns = array("msisdn","trx_date","event_name","event_details");
                $titles = array("msisdn", "TRX Date","Event","Event Details");

...
<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Bank To M-PESA Incentive Transaction History</p>
        <br />
        <form name='sci_query_customer_history' action='lnm_mbi_query_customer_history.php' method='post'>
        <center>

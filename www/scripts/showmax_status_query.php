...
<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">ShowMax Request Status</p>
        <br />
        <form name='showmax' action='showmax_status_query.php' method='post'>
        <center>
        ...
        ?>
			...
			<?php
		$tables = array("VW_SHOWMAX_SUBSCRIPTIONS");
				$columns = array("DATE_CREATED","REQUEST_MSISDN","BENEFIT_MSISDN","TOTAL_AMOUNT","MPESA_TRANSACTION_ID","MPESA_RESULT_DESC","CBS_PRODUCT_DESC","CBS_RESPONSE_DESC","SHOWMAXTYPE","SHOWMAX_RESPONSE");
                $titles = array("DATE","REQUEST_NO","BENEFIT_NO","TOTAL", "MPESA_TRX","MPESA_DESC","CBS_PRODUCT","CBS_RESPONSE","SHOWMAXTYPE","SHOWMAXRESP");
				
                $advanced = "where SUBSTR(REQUEST_MSISDN,-9) = '".substr($_POST['msisdn'],-9)."' order by DATE_CREATED desc ";

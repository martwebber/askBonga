...
<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Merchant Mpesa Transaction History Details</p>
        <br />
        <form name='request_history' action='lnm_2014_m_transaction_history.php' method='post'>
        <center>

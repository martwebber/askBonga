...
<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Mauzo Code Details</p>
        <br />
        <form name='mauzo_code' action='query_mauzo_code_2014.php' method='post'>
        <center>
        <table class="tablebody border" width="80%">
			<tr>
				<th colspan="2" class="tableheader"><b>MAUZO CODE SEARCH</b></th>
			</tr>
			<tr>
				<td><br />MAUZO CODE: </td><td><br /><input type='text' name='serial_pin_' />&nbsp;&nbsp; (Starts with 3 letters followed by 9 digits) </td>
			</tr>
            <tr>
        ...
        <?php
            if (isset($_POST['serial_pin_']) && $error == "") {
        ?>
			<input type="hidden" name="confirm_deletion" id="confirm_deletion" />
			<!--<input type="hidden" name="msisdn" id="msisdn" value="<?php echo $_POST['serial_pin_']; ?>" />-->
			<?php
$tables = array("serial_pins");
				$columns = array("pin","denomination","msisdn","trx_date");
                $titles = array("PIN", "DENOMINATION","MSISDN", "REDEEM DATE");
                $advanced = "where trim(pin) = '".trim($_POST['serial_pin_'])."'";
				$display_str = $db->display_records($tables, $columns, $titles, "mauzo_code", $advanced, null, null, "");

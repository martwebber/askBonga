...
<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Customer Interaction History Details</p>
        <br />
        <form name='request_history' action='tlnm_customer_history.php' method='post'>
        <center>
        ...
        ?>
			...
			<?php			
				$tables = array("tbl_tlnm_request_hist");
				$columns = array("msisdn","to_char(TRX_DATE,'dd-Mon-yyyy hh24:mi:ss')","EVENT_DETAILS");

<?php
    ...
    $query = "SELECT bundle_id, description FROM bundles_info where description is not null order by bundle_id";
    ...
    if (isset($_POST['msisdn'])) {
        ...
        if ($error == "") {
            ...
            $db->open_connection();
            $query = "BEGIN CM_ADHOC_BUNDLES_REQUEST(:IN_MSISDN, :IN_BUNDLE_ID, :IN_SR_NUMBER, :IN_SUB_TYPE, :IN_TRX_DETAIL); END;";
...
<div class="cspacer">
	...
	<form name="award_adhoc" action="award_pcrf_bundle.php" method="post">
		<center>

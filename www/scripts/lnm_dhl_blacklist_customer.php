...
<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Blacklisted MSISDN for LNM DHL Campaign</p>
        <br />
        <form name='lnm_dhl_blacklist_customer' action='lnm_dhl_blacklist_customer.php' method='post'>
        <center>
        ...
        ?>
			...
			<?php
$tables = array("tbl_dhl_blacklist");
				$columns = array("msisdn","general_comments");
                $titles = array("msisdn", "whitelist_reason");
                $advanced = "where msisdn = '".'254'.substr($_POST['msisdn'],-9)."'";
				$display_str = $db->display_records($tables, $columns, $titles, "lnm_dhl_blacklist_customer", $advanced, null, null, "");

...
<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Merchant Transaction History Details</p>
        <br />
        <form name='request_history' action='lnm_2015_m_customer_history.php' method='post'>
        <center>
        ...
        ?>
			...
			<?php
$tables = array("tbl_lnm_m_request_hist");

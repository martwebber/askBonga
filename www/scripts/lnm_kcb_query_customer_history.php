...
<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">KCB Lipa Na M-PESA Interaction History</p>
        <br />
        <form name='kcb_query_customer_history' action='lnm_kcb_query_customer_history.php' method='post'>
        <center>
...
$tables = array("vw_kcb_staging");
				...
				$display_str = $db->display_records($tables, $columns, $titles, "kcb_query_customer_history", $advanced, null, null, "");

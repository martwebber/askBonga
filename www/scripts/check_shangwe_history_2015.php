...
<div class="cspacer">
		...
		<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Shangwe Mtaani 2015 Participant Activity History</p>
        <br />
  
        <form name='points_list' action='check_shangwe_history_2015.php' method='post'>
        <center>
        ...
        ?>
                        ...
                        <?php
                                $tables = array("TBL_BO15_REQUESTS_HISTORY");

...
<div class="cspacer">
		...
		<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Shinda Ma-Milli na Stori Ibambe 2016 Participant Details</p>
        <br />
  
        <form name='points_list' action='check_storo_details_2016.php' method='post'>
        <center>
        ...
        ?>
                        ...
                        <?php
                                $tables = array("samsung_promo.tbl_storo_subscribers");
                                $columns = array("msisdn", "Region_name", "to_char(join_date, 'dd-MON-yyyy hh24:mi')","to_char(last_update, 'dd-MON-yyyy hh24:mi')","case when is_active= 1  then 'Active in Promo' when is_active= 0  then 'Opted Out' end as is_active");
                $titles = array("MSISDN", "Region","Join Date", "Last Update","Status");

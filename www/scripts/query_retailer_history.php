...
<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Retailer Interaction History Details</p>
        <br />
        <form name='request_history' action='query_retailer_history.php' method='post'>
        <center>
        ...
        ?>
			...
			<?php
$tables = array("TBL_REQUEST_HISTORY");
				$columns = array("msisdn","to_char(TX_DATE,'dd-Mon-yyyy hh24:mi')","REQUEST_DETAILS");
                $titles = array("msisdn", "TxDate","Event_Details");
                $advanced = "where substr(msisdn,-9) = '".substr($_POST['msisdn'],-9)."' order by rid desc";

...
<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Mshwari Stawisha Promo Winner Details</p>
        <br />
        <form name='winner' action='stawisha_query_winner.php' method='post'>
        <center>
        ...
        ?>
			...
			<?php
$tables = array("vw_cba_winners");
				/*$columns = array("msisdn","draw_date","prize_name","confirm_winner","prize_key");
                $titles = array("msisdn", "Draw Date","Prize","Confirmed Status","Prize Type");
                $advanced = "where msisdn = '".'254'.substr($_POST['msisdn'],-9)."'";
				$display_str = $db->display_records($tables, $columns, $titles, "winner", $advanced, null, null, "");
				*/
				
				$columns = array("msisdn","draw_date","date_of_win","prize_name","to_char(prize_value,'9,999,999.99')");
                $titles = array("msisdn", "Draw Date","Date of Win","Prize","Prize Value");
                $advanced = "where msisdn = '".'254'.substr($_POST['msisdn'],-9)."' and confirm_winner='YES'";
				$display_str = $db->display_records($tables, $columns, $titles, "winner", $advanced, null, null, "");

...
<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Promo Whitelist Details</p>
        <br />
        <form name='blacklist' action='voicepromo_query_whitelist.php' method='post'>
        <center>
        ...
        ?>
			...
			<?php
$tables = array("VW_VOICE_WHITELIST");

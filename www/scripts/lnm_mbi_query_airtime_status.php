...
<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Bank To M-PESA Incentive Airtime Awards</p>
        <br />
        <form name='sci_winner' action='lnm_mbi_query_airtime_status.php' method='post'>
        <center>
...
$tables = array("TBL_SFCR_AWARDS");
                ...
                $advanced = "where PROMO_ID=3 AND msisdn = '".'254'.substr($_POST['msisdn'],-9)."' order by trx_date desc";

<?php
	...
	if (isset($_POST['submit_request']) )
	{
            ...
            if ($error == "") {
                ...
                $db->open_connection();
		//SMS_BUNDLE_EXPIRATION_CM (IN_MSISDN IN NUMBER, IN_CHANNEL IN VARCHAR2)
                $query = "BEGIN SMS_BUNDLE_EXPIRATION_CM(:IN_MSISDN, :IN_CHANNEL); END;";
...
<div class="cspacer">
	...
	<div align="center" style="text-align:left; width:100%">
        ...
        <form name='form_unsubscribe' action='sms_unsubscribe.php' method='post'>
        <center>
        <table class="tablebody border" width="80%">
			<tr>
				<th colspan="2" class="tableheader"><b>MASAA YA SMS: MSISDN SEARCH</b></th>
			</tr>
			<tr>

...
<div class="cspacer">
        ...
        <form name='points_list' action='mpesa_partner_statements_check_registration.php' method='post'>
        <center>
        ...
        ?>
                        ...
                        <?php
                                $tables = array("vw_stmt_registrations");
                                $columns = array("msisdn", "short_code","email_address","id_number", "creation_date","EMAIL_CONFIRMED","statement_period");
                                $titles = array("MSISDN", "Store Number","E-mail Address", "Id Number", "Registration Date","EMAIL_CONFIRMED","statement_period");

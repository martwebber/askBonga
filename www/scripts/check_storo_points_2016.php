...
<div class="cspacer">
        ...
        <form name='points_list' action='check_storo_points_2016.php' method='post'>
        <center>
        ...
        ?>
                        ...
                        <?php
                                ...
                                $columns = array("MSISDN","Region_name","to_char(last_update, 'dd-MON-yyyy hh24:mi')","case when is_active= 1  then 'Active in Promo' when is_active= 0  then 'Opted Out' end as is_active");
                $titles = array("MSISDN","Region", "Last Update","Status");

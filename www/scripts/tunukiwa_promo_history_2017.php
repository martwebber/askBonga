...
<div class="cspacer">
		...
		<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Shinda Ma-milli na Tunukiwa Activity History</p>
        <br />
  
        <form name='points_list' action='tunukiwa_promo_history_2017.php' method='post'>
        <center>
        ...
        ?>
                        ...
                        <?php
                                $tables = array("TBL_SMNT_REQUEST_HIST");

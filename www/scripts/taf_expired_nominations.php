...
<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">M-Shwari Tell a Friend Expired Nominations</p>
        <br />
        <form name='taf_expired' action='taf_expired_nominations.php' method='post'>
        <center>
        ...
        ?>
			...
			<?php
$tables = array("TBL_TAF_EXPIRED_REQUESTS");
				$columns = array("nominator_msisdn","Nominee","trx_date");
                $titles = array("Nominator", "Nominee","Nomination Date");
                $advanced = "where substr(nominator_msisdn,-9) = '".substr($_POST['msisdn'],-9)."'";
				$display_str = $db->display_records($tables, $columns, $titles, "taf_expired", $advanced, null, null, "");

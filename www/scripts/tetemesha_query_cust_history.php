...
<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Tetemesha 2014 Interaction History Details</p>
        <br />
        <form name='request_history' action='tetemesha_query_cust_history.php' method='post'>
        <center>
        ...
        ?>
			...
			<?php
$tables = array("tbl_request_hist");
				$columns = array("msisdn","to_char(trx_date,'DD-MON-YYYY')","event","event_details");
                $titles = array("msisdn", "TrxDate","Event","Event_Details");

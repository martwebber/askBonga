...
<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">DHL Lipa Na M-PESA Interaction History</p>
        <br />
        <form name='dhl_query_customer_history' action='lnm_dhl_query_customer_history.php' method='post'>
        <center>

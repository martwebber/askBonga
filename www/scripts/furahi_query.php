...
<div class="cspacer">
	...
	<div align="center" style="text-align:left; width:100%">
        ...
        <form name='acc_history_list' action='furahi_query.php' method='post'>
        <center>
        ...
        ?>
			...
			<?php
				...
				$tables = array("topup_fiesta.entry_points");
				...
				$columns = array("msisdn", "points", "to_char(last_updated, 'dd-Mon-yyyy hh24:mi')", "subscriber_type");
                $titles = array("msisdn", "points", "last_updated", "subscriber_type");

...
<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">White listed MSISDN for KCB CVM Campaign</p>
        <br />
        <form name='lnm_kcb_whiteliisted_customer' action='lnm_kcb_whiteliisted_customer.php' method='post'>
        <center>
        ...
        ?>
			...
			<?php
$tables = array("tbl_kcb_whitelist");
				$columns = array("msisdn","whitelist_reason");
                $titles = array("msisdn", "whitelist_reason");
                $advanced = "where msisdn = '".'254'.substr($_POST['msisdn'],-9)."'";
				$display_str = $db->display_records($tables, $columns, $titles, "lnm_kcb_whiteliisted_customer", $advanced, null, null, "");

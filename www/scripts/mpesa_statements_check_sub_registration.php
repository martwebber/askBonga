...
<div class="cspacer">
		...
		<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">M-PESA Statements Registration Details</p>
        <br />
  
        <form name='points_list' action='mpesa_statements_check_sub_registration.php' method='post'>
        <center>
        ...
        ?>
                        ...
                        <?php
                                $tables = array("vw_mstmt_registrations");
                                $columns = array("msisdn", "email_address","registration_doc_no", "to_char(registration_date, 'dd-MON-yyyy hh24:mi')","status","registration_completion_status");
                $titles = array("MSISDN", "E-mail Address", "Document No", "Registration Date","Status","Registration Status");

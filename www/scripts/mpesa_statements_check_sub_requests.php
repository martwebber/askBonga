...
<div class="cspacer">
		...
		<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">M-PESA Statements - Query Requests</p>
        <br />
  
        <form name='points_list' action='mpesa_statements_check_sub_requests.php' method='post'>
        <center>
        ...
        ?>
                        ...
                        <?php
                                $tables = array("vw_mstmt_requests");
                                $columns = array("serial_no","msisdn", "email_address","statement_type", "to_char(date_requested, 'dd-MON-yyyy hh24:mi')","statement_period","status");
                $titles = array("REQUEST_ID","MSISDN", "E-mail Address", "Statement Type","Request Date", "Period","Status");

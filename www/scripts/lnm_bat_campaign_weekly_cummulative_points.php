...
<div class="cspacer">
		...
		<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">BAT Campaign Participant Weekly Cumulative Amount </p>
        <br />
  
        <form name='points_list' action='lnm_bat_campaign_weekly_cummulative_points.php' method='post'>
        <center>
        ...
        ?>
                        ...
                        <?php
                                $tables = array("vw_bat_weekly_cumulative");

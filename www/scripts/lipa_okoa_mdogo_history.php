...
<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Lipa Mdogo Mdogo - Customer Interaction History</p>
        <br />
        <form name='request_history' action='lipa_okoa_mdogo_history.php' method='post'>
        <center>
        ...
        ?>
			...
			<?php			
			$tables = array("tbl_okoa_msisdn_logs");
			$columns = array("msisdn","to_char(TRX_DATE,'dd-Mon-yyyy hh24:mi:ss')","case when   okoa_io =1 then 'Opt-It' when   okoa_io =2 then 'Opt-Out' end as Event_details ");

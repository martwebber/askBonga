<?php
    ...
    $BONGA_DATABASEHOST = "10.5.40.99";
    $BONGA_DATABASEPORT = "1521";
    $BONGA_DATABASEUSER = "simswap";
    $BONGA_DATABASEPASSWORD = "simswap123";
    $BONGA_DATABASENAME = "resdev";
...
<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Query Self-SIMSwap Details by MSISDN being swapped</p>
        <br />
        <form name='query_self_swap_details' action='query_self_swap_details_swapee.php' method='post'>
        <center>
        ...
        ?>
			...
			<?php
$tables = array("tbl_ussd_selfswap_cm");
				$columns = array("swap_msisdn","date_of_request","imsi","swap_attempt_outcome","recommended_action");
                $titles = array("Msisdn", "TrxDate","IMSI","Swap Outcome","Recommendation");
                $advanced = "where substr(swap_msisdn,-9) = '".substr($_POST['msisdn'],-9)."' order by cmid desc";
				$display_str = $db->display_records($tables, $columns, $titles, "query_self_swap_details", $advanced, null, null, "");

...
<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Jambo Jet Incentive Transaction History</p>
        <br />
        <form name='sci_query_customer_history' action='lnm_jamboj_query_cust_history.php' method='post'>
        <center>
...
$tables = array("VW_JJ_STAGING");
				...
				$display_str = $db->display_records($tables, $columns, $titles, "JamboJet_query_customer_history", $advanced, null, null, "");

...
//                                echo $errorMessage;
            ...
            if (isset($_POST['PROCCESS_TYPE'])) {
                ...
                <?php
                $dbconn = oci_connect("TIBCOEHF", 'goodmonger123', "172.29.246.68:1521/TIBCODB");
...
//                    echo "Connected";
					...
					if ($msisdn!=''){
                    $sql = "SELECT PP_ID, PP_MSISDN, PP_DEPOSIT_AMOUNT, PP_PROCESS_STATUS, PP_REQUEST_DATE, PP_ORDER_TYPE, PP_ORDER_PROFILE,PP_ERROR_MSG FROM PP_PRE2HYB_REQUESTS WHERE  PP_MSISDN = '$msisdn' ORDER BY PP_REQUEST_DATE DESC ";
					} else {
					$sql = "SELECT PP_ID, PP_MSISDN, PP_DEPOSIT_AMOUNT, PP_PROCESS_STATUS, PP_REQUEST_DATE, PP_ORDER_TYPE, PP_ORDER_PROFILE,PP_ERROR_MSG FROM PP_PRE2HYB_REQUESTS WHERE  PP_PROCESS_STATUS = '$process_status' OR PP_MSISDN = '$msisdn' ORDER BY PP_REQUEST_DATE DESC";
					}	

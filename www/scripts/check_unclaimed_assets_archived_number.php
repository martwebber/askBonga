...
<br />
        ...
        <br />
        <form name='query_unclaimed_archived_number' action='check_unclaimed_assets_archived_number.php' method='post'>
        <center>
        ...
        ?>
			...
			<?php
$tables = array("TBL_UNCLAIMED_ASSETS_MST");
				$columns = array("ARCHIVED_MOBILE","CLAIMANT_MSISDN", "ID_NUMBER", "case  when RECLAIMED =  '0' THEN 'Not Claimed' else 'Claimed Successfully' end RECLAIMED");
                
				$titles = array("ARCHIVED","BENEFICIARY","BENEFICIARY ID","CLAIM STATUS");
                //$advanced = "where substr(msisdn,-9) = ".substr($_POST['msisdn'],-9)."";
				$advanced = "where ARCHIVED_MOBILE = ".substr($_POST['msisdn'],-9)." or CLAIMANT_MSISDN = 254".substr($_POST['msisdn'],-9)."";
				$display_str = $db->display_records($tables, $columns, $titles, "query_unclaimed_archived_number", $advanced, null, null, "3");
				echo "</br></br>";

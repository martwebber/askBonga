...
<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Query Self-SIMSwap Details</p>
        <br />
        <form name='query_self_swap_details' action='query_self_swap_details.php' method='post'>
        <center>
...
$tables = array("tbl_ussd_selfswap_cm");
                ...
                $advanced = "where substr(sender_msisdn,-9) = '".substr($_POST['msisdn'],-9)."' order by cmid desc";

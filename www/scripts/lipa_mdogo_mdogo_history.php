...
<br />
        ...
        <br />
        <form name='request_history' action='lipa_mdogo_mdogo_history.php' method='post'>
        <center>
        ...
        ?>
			...
			<?php			
				$tables = array("tbl_okoa_staggered_req_hist");
				$columns = array("msisdn","to_char(TRX_DATE,'dd-Mon-yyyy hh24:mi:ss')","EVENT","EVENT_DETAILS");
                $titles = array("MSISDN", "Date","Event","Event Details");

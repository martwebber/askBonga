...
<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">M-Shwari Tell A Friend Airtime Awards</p>
        <br />
        <form name='taf_airtime_winner' action='taf_airtime_winners.php' method='post'>
        <center>
        ...
        ?>
			...
			<?php
$tables = array("TBL_TAF_AIRTIME_AWARDS");
				$columns = array("msisdn","trx_date","airtime_award_status","airtime_award_date");
                $titles = array("msisdn", "TRX Date","Airtime Status","Airtime Award Date");

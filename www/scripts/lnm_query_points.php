...
<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Lipa Na MPESA with Uchumi Promo Query Points Details</p>
        <br />
        <form name='query_points' action='lnm_query_points.php' method='post'>
        <center>
        ...
        ?>
			...
			<?php
$tables = array("tbl_lnm_summary_pts");
				$columns = array("msisdn","points","decode(active_status,'1','NORMAL','0','OPTED_OUT','-1','BLACKLIST','Unknown')","nvl(to_char(opt_out_date,'DD-MON-YYYY'),'N/A')");
                $titles = array("msisdn", "Entries","Status", "Opt-Out Date");

...
<div class="cspacer">
		...
		<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Lipa Na MPESA Naivas Supermarket Winnings</p>
        <br />
  
        <form name='winnings_list' action='nlnm_check_winnings.php' method='post'>
			<center>
			...
			?>
							...
							<?php
									...
									$tables = array("VW_NLNM_WINNERS");
									$columns = array("msisdn", "prize_name", "draw_date", "date_of_win");

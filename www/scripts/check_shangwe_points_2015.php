...
<?php
    ...
    $BONGA_DATABASEPASSWORD = "b0ny3zachapa";    $BONGA_DATABASENAME = "heko";
...
<div class="cspacer">
		...
		<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Shangwe Mtaani 2015 Participant Points</p>
        <br />
  
        <form name='points_list' action='check_shangwe_points_2015.php' method='post'>
        <center>
        ...
        ?>
                        ...
                        <?php
                                ...
                                $columns = array("MSISDN", "POINTS", "to_char(last_update, 'dd-MON-yyyy hh24:mi')");
                $titles = array("MSISDN", "Points", "Last Update");

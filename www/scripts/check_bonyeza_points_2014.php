...
<div class="cspacer">
		...
		<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Bonyeza 2014 Participant Points</p>
        <br />
  
        <form name='points_list' action='check_bonyeza_points_2014.php' method='post'>
        <center>
        ...
        ?>
                        ...
                        <?php
                                $tables = array("TBL_BO_SUBSCRIBERS");

...
<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Web Selfcare Promo Customer Attempts</p>
        <br />
        <form name='request_history' action='selfcare_attempts.php' method='post'>
        <center>
        ...
        ?>
			...
			<?php
$tables = array("WSC_TRANSACTIONS");
				$columns = array("trans_msisdn","trans_date","trans_wsc_username","trans_correct_wrong","trans_attempt_digits");
                $titles = array("Msisdn", "TrxDate","Username","Status","Attempts");
                $advanced = "where substr(trans_msisdn,-9) = '".substr($_POST['msisdn'],-9)."' order by id desc";

...
<div class="cspacer">
		...
		<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Lipa Na Mpesa Merchant Winnings</p>
        <br />
  
        <form name='winnings_list' action='lnm_2015_m_check_winnings.php' method='post'>
        <center>
        ...
        ?>
                        ...
                        <?php
								...
								$titles = array("MSISDN", "Prize Name", "Draw Date", "Date Won","Award Status","Award Date");
								$advanced = "where substr(msisdn,-9) = ".substr($_POST['msisdn'],-9)." and confirm_winner='YES'";
                                $display_str = $db->display_records($tables, $columns, $titles, "winnings_list", $advanced, null, null, "");

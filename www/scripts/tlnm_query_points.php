...
<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Tuskys Promo Query Points Details</p>
        <br />
        <form name='query_points' action='tlnm_query_points.php' method='post'>
        <center>
        ...
        ?>
			...
			<?php
$tables = array("tbl_tlnm_summary_points");
				$columns = array("msisdn","points","decode(active_status,'0','OPTED_OUT','1','ACTIVE','Unknown')","nvl(to_char(opt_out_date,'DD-MON-YYYY  HH24:MI'),'N/A')","to_char(last_updated,'DD-MON-YYYY  HH24:MI')");

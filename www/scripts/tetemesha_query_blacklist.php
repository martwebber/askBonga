...
<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Tetemesha 2014 Blacklist Details</p>
        <br />
        <form name='blacklist_details' action='tetemesha_query_blacklist.php' method='post'>
        <center>
        ...
        ?>
			...
			<?php
				...
				$display_str = $db->display_records($tables, $columns, $titles, "blacklist_details", $advanced, null, null, "");

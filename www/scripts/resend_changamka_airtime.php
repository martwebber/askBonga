    ...
    if (isset($_POST['msisdn'])) {
		...
		if ($error == "") {
			...
			if ($error == "") {
				...
				$query = "BEGIN RESEND_AIRTIME_PIN(:IN_MSISDN, :IN_SERIAL_NUMBER, :OUT_MESSAGE); END;";
				...
				logmessage("DEBUG", "Resend kabambe airtime: ".$in_msisdn."; $serial_number; ".$_POST['sr_number']."; ".$_SESSION['USERID']);
...
<div class="cspacer">
	...
	<div align="center" style="text-align:left; width:100%">
		...
		<form name='acc_history_list' action='resend_changamka_airtime.php' method='post'>
		<center>

...
<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Mshwari Stawisha Promo Interaction History Details</p>
        <br />
        <form name='request_history' action='stawisha_query_customer_history.php' method='post'>
        <center>
        ...
        ?>
			...
			<?php
$tables = array("tbl_cba_request_hist");

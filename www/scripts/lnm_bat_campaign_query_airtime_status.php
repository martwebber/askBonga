...
<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">BAT Excite, Airtime Awards</p>
        <br />
        <form name='bata_winner' action='lnm_bat_campaign_query_airtime_status.php' method='post'>
        <center>
        ...
        ?>
			...
			<?php
$tables = array("tbl_bat_airtime_award");
				$columns = array("msisdn","trx_date","ref_id","AIRTIME_AWARD_DETAILS","airtime_award_date","air_time/10000  air_time" );
                $titles = array("msisdn", "TRX Date","Ref ID","Airtime Status","Airtime Award Date","Airtime Value");

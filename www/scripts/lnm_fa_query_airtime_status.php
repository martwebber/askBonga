...
<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Lipa Fuel Na M-PESA, Airtime Awards</p>
        <br />
        <form name='bata_winner' action='lnm_fa_query_airtime_status.php' method='post'>
        <center>
        ...
        ?>
			...
			<?php
$tables = array("tbl_lnm_fa2_airtime_award");

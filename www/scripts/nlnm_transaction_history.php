...
<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Naivas Lipa Na Mpesa Transaction History Details</p>
        <br />
        <form name='request_history' action='nlnm_transaction_history.php' method='post'>
        <center>

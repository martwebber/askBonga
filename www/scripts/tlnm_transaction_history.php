...
<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Transaction History Details</p>
        <br />
        <form name='request_history' action='tlnm_transaction_history.php' method='post'>
        <center>

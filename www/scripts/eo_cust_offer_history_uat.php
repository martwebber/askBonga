...
<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">View Offers</p>
        <br />
        <form name='query_points' action='eo_cust_offer_history_uat.php' method='post'>
        <center>
        ...
        ?>
			...
			<?php
$tables = array("western_union.vw_eo_sub_offer_hist");
				$columns = array("msisdn","offer_day","offer_date","offer_name","ussd_name");
                
				$titles = array("msisdn","offer_day","offer_date","offer_name","ussd_name");

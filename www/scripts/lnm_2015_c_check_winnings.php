...
<div class="cspacer">
		...
		<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Lipa Na Mpesa Consumer Winnings</p>
        <br />
  
        <form name='winnings_list' action='lnm_2015_c_check_winnings.php' method='post'>
        <center>

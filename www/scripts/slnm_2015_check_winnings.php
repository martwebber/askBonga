...
<div class="cspacer">
		...
		<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Lipa Na Mpesa Staff Winnings</p>
        <br />
  
        <form name='winnings_list' action='slnm_2015_check_winnings.php' method='post'>
        <center>

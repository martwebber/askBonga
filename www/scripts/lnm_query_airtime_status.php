...
<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Airtime Award Status Details</p>
        <br />
        <form name='winner' action='lnm_query_airtime_status.php' method='post'>
        <center>
...
$tables = array("vw_winners");
				$columns = array("msisdn","draw_date","prize_name","airtime_award_status","airtime_award_date");
                $titles = array("msisdn", "Draw Date","Prize","Airtime Status","Airtime Award Date");

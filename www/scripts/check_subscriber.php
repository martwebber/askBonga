...
<div class="cspacer">
	...
	<div align="center" style="text-align:left; width:100%">
        ...
        <form name='sub_history_list' action='check_subscriber.php' method='post'>
        <center>
        ...
        ?>
			...
			<?php
				...
				$columns = array("msisdn", "subscriber_type", "package_id", "to_char(subscription_date, 'dd-MON-yyyy hh24:mi')", "to_char(expiry_date, 'dd-MON-yyyy hh24:mi')", "a.description");
                $titles = array("msisdn", "subscriber_type", "bundle", "subscription_date", "expiry_date", "status");
                $advanced = "where s.subscriber_status = a.subscriber_status and s.subscription_type = b.bundle_id and msisdn = ".substr($_POST['msisdn'], -9);

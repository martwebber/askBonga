...
<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">KCB Lipa Na M-PESA Airtime Awards</p>
        <br />
        <form name='kcb_winner' action='lnm_kcb_query_airtime_status.php' method='post'>
        <center>
        ...
        ?>
			...
			<?php
$tables = array("TBL_KCB_AIRTIME_AWARD");

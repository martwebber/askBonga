...
<br />
        ...
        <br />
        <form name='query_purchase_history' action='eo_cust_offer_purchase_history_uat.php' method='post'>
        <center>
        ...
        ?>
			...
			<?php
$tables = array("western_union.vw_eo_offer_request_history");
				$columns = array("msisdn","to_char(trx_date,'DD-MON-YYYY HH24:MI:SS')","offer_name","purchase_type","request_status","purchase_details","award_details","sms_sent");
                
				$titles = array("msisdn","date","offer","purchase type","status","purchase_details","award_details","sms_sent");

...
<div class="cspacer">
		...
		<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">CHANUA BIZ(Query Dealer Sales Agent)</p>
        <br />
  
        <form name='dsa_details' action='RLNM_DSA.php' method='post'>
        <center>
        ...
        ?>
                        ...
                        <?php
                                ...
                                $columns = array("ID","MSISDN","DEALER_CODE","TILL","TILL_MSISDN","REGISTER_DATE","CREDIT_VALUE","DEALER_NAME","DS_ORGA_NAME");
								$titles = array("ID","MSISDN","DEALER CODE","TILL","TILL MSISDN","REGISTRATION DATE","CREDIT VALUES","DEALER NAME","DEALER BRANCH");
								$advanced = "WHERE MSISDN = '".'254'.substr($_POST['msisdn'],-9)."' ORDER BY ID DESC";
                                $display_str = $db->display_records($tables, $columns, $titles, "dsa_details", $advanced, null, null, "");
                                echo $display_str;
                        ?>
                </form>
        <?php

...
<div class="cspacer">
		...
		<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">BAT Campaign Participant Weekly Amount </p>
        <br />
  
        <form name='points_list' action='lnm_bat_campaign_points.php' method='post'>
        <center>
        ...
        ?>
                        ...
                        <?php
                                $tables = array("tbl_bat_summary_points");
                                $columns = array("msisdn", "points", "to_char(last_updated, 'dd-MON-yyyy hh24:mi')");

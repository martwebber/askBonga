...
<div class="cspacer">
	...
	<div align="center" style="text-align:left; width:100%">
        ...
        <form name='acc_history_list' action='check_kabambe_history.php' method='post'>
        <center>
        ...
        ?>
			...
			<?php
				...
				$columns = array("msisdn", "to_char(date_received, 'dd-MON-yyyy hh24:mi')", "message");
                $titles = array("msisdn", "request_date", "message");

...
<div class="cspacer">
        ...
        <form name='activity_list' action='mpesa_statements_check_sub_activity.php' method='post'>
        <center>
        ...
        ?>
                        ...
                        <?php
                                $tables = array("vw_mstmt_request_history");
                                $columns = array("msisdn", "action","action_details", "to_char(action_date, 'dd-MON-yyyy hh24:mi')");

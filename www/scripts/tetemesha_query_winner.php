<?php
    ...
    $BONGA_DATABASEUSER = "tetemesha2014";
    $BONGA_DATABASEPASSWORD = "t#t#m#sha2014#$";
...
<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Tetemesha 2014 Winner Details</p>
        <br />
        <form name='winner' action='tetemesha_query_winner.php' method='post'>
        <center>
        ...
        ?>
			...
			<?php
$tables = array("vw_winners");
				$columns = array("msisdn","draw_date","prize_name","confirm_winner","airtime_award_status","airtime_award_date");
                $titles = array("msisdn", "Draw Date","Prize","Confirmed Status","Airtime Status","Airtime Date");

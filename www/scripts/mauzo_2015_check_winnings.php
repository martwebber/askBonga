...
<div class="cspacer">
		...
		<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Mauzo Kochokocho Participant Winnings</p>
        <br />
  
        <form name='winnings_list' action='mauzo_2015_check_winnings.php' method='post'>
        <center>
        ...
        ?>
                        ...
                        <?php
                                ...
                                $columns = array("msisdn", "prize_name", "to_char(win_date, 'dd-MON-yyyy hh24:mi')","AIRTIME_AWARD_STATUS","AIRTIME_AWARD_DATE");
                $titles = array("MSISDN", "Prize", "Date Won","Airtime Award Status","Airtime Award Date");
                $advanced = "where substr(msisdn,-9) = ".substr($_POST['msisdn'],-9)." And Confirmed='YES'";

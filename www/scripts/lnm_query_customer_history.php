...
<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Lipa Na Mpesa Promo Interaction History Details</p>
        <br />
        <form name='request_history' action='lnm_query_customer_history.php' method='post'>
        <center>
        ...
        ?>
			...
			<?php
$tables = array("tbl_lnm_request_hist");

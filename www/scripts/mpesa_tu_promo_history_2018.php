...
<div class="cspacer">
		...
		<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">MPESA TU Promo Participant History</p>
        <br />
        ...
        ?>
                        ...
                        <?php
                                $tables = array("LNM_CVM.TBL_mtp_REQUEST_HIST");

...
<div class="cspacer">
		...
		<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">BAT Excite Participant Cumulative Amount during campaign period. </p>
        <br />
  
        <form name='points_list' action='lnm_bat_campaign_overall_cumulative.php' method='post'>
        <center>
        ...
        ?>
                        ...
                        <?php
                                $tables = array("vw_bat_overall_cumulative");
                                
								$columns = array("msisdn ", "to_char(trx_date, 'dd-MON-yyyy hh24:mi')", "distributor", "amount", "mpesa_trx_id", "weekly_cummulative", "campaign_period" );
                $titles = array("MSISDN ", "Trx Date", "Distributor", "Amount", "M-PESA TRX ID", "Cumulative Amount", "Campaign Period");

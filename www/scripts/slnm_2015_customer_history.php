...
<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Staff Interaction History Details</p>
        <br />
        <form name='request_history' action='slnm_2015_customer_history.php' method='post'>
        <center>
        ...
        ?>
			...
			<?php			
				$tables = array("tbl_slnm_request_hist");

...
<div class="cspacer">
		...
		<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Shinda Ma-milli na Tunukiwa Participant Entries</p>
        <br />
  
        <form name='points_list' action='tunukiwa_promo_points_2017.php' method='post'>
        <center>
        ...
        ?>
                        ...
                        <?php
                                ...
                                $columns = array("MSISDN", "POINTS","REGION_NAME", "to_char(last_update, 'dd-MON-yyyy hh24:mi')");
                $titles = array("MSISDN", "Entries", "Region Name","Last Update");

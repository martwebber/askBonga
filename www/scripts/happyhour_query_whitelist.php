...
<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Whitelist Details</p>
        <br />
        <form name='blacklist' action='happyhour_query_whitelist.php' method='post'>
        <center>
        ...
        ?>
			...
			<?php
$tables = array("TBL_HH_WHITELIST");
				$columns = array("msisdn");
                $titles = array("msisdn");
                $advanced = "where msisdn = '".$_POST['msisdn']."'";
				$display_str = $db->display_records($tables, $columns, $titles, "Whitelist", $advanced, null, null, "");

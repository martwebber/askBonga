...
<div class="cspacer">
		...
		<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Shinda Ma-Milli na Stori Ibambe 2016 Participant Winnings</p>
        <br />
  
        <form name='winnings_list' action='check_storo_winnings_2016.php' method='post'>
        <center>
        ...
        ?>
                        ...
                        <?php
							$tables = array("samsung_promo.VW_STORO_WINNERS_00");
							$columns = array("msisdn","region_name", "prize_name", "to_char(win_date, 'dd-MON-yyyy hh24:mi')","Award_Status","Award_Date", "MPESA_TRX_ID","Confirmed");
                $titles = array("MSISDN","Win Region", "Prize", "Date Won","Award Status","Award Date","MPESA_TRX_ID","Confirmed");

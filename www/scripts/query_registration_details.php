...
<div class="cspacer">
	...
	<div align="center" style="text-align:left; width:100%">
		<!--<table class="tablebody border" width="100%">
		 ...
		 <br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Retailer Registration Details</p>
        <br />
        <form name='registrations' action='query_registration_details.php' method='post'>
        <center>
        ...
        ?>
			...
			<?php
				...
				$columns = array("msisdn","ID_NUMBER","CLUSTER_CODE","to_char(REGISTRATION_DATE,'dd-Mon-yyyy hh24:mi')","RETAILER_NAME");
                $titles = array("msisdn","ID Number","Cluster Code","Registration_Date","Retailer Name");
                $advanced = "where substr(msisdn,4,9) = '".substr($_POST['msisdn'],-9)."'";
				$display_str = $db->display_records($tables, $columns, $titles, "registrations", $advanced, null, null, "");

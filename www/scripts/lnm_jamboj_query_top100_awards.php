...
<br />
        ...
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Jambo Jet Incentive Airtime Awards</p>
        <br />
        <form name='sci_winner' action='lnm_jamboj_query_top100_awards.php' method='post'>
        <center>
        <table class="tablebody border" width="80%">
			<tr>
				<th colspan="2" class="tableheader"><b>AWARD DATE SEARCH</b></th>
			</tr>
			<tr>
				<td>
				<br />AWARD DATE: </td>
						<td>
							<br /><input type='text' name='my_trx_date' value="<?php echo $_POST['my_trx_date']; ?>"/>&nbsp;&nbsp; (Date Format: YYYYMMDD) 
				</td>
			</tr>
            <tr>
        ...
        <?php
            if (isset($_POST['my_trx_date']) && $error == "") {
        ?>
			<input type="hidden" name="confirm_deletion" id="confirm_deletion" />
			<!--<input type="hidden" name="msisdn" id="msisdn" value="<?php echo $_POST['my_trx_date']; ?>" />-->
			<?php
$tables = array("VW_JJ_SFCR_AWARDS");
                ...
                $advanced = "where PROMO_ID=5 AND to_char(trx_date,'yyyymmdd') = '".$_POST['my_trx_date']."' order by trx_date desc";
				$display_str = $db->display_records($tables, $columns, $titles, "Jambo Jet Airtime", $advanced, null, null, "");

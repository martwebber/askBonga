...
<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">Mshwari Stawisha Promo Query Points Details</p>
        <br />
        <form name='query_points' action='stawisha_query_points.php' method='post'>
        <center>
        ...
        ?>
			...
			<?php
$tables = array("tbl_cba_summary_pts");
				$columns = array("msisdn","weekly_pts","decode(active_status,'-1','OPTED_OUT','0','ACTIVE','Unknown')","nvl(to_char(opt_out_date,'DD-MON-YYYY  HH24:MI'),'N/A')","to_char(last_updated,'DD-MON-YYYY  HH24:MI')");

...
<br />
        ...
        <br />
        <form name='sci_winner' action='lnm_jamboj_query_airtime_status.php' method='post'>
        <center>
        <table class="tablebody border" width="80%">
			...
			<tr>
				...
				<br />MSISDN: </td>
						<td>
							<br /><input type='text' name='msisdn' value="<?php echo $_POST['msisdn']; ?>"/>&nbsp;&nbsp; (Format: 07XXYYYZZZ) 
				</td>
			</tr>
            <tr>
...
$tables = array("VW_JJ_SFCR_AWARDS");
                ...
                $advanced = "where PROMO_ID=5 AND msisdn = '".'254'.substr($_POST['msisdn'],-9)."' order by trx_date desc";

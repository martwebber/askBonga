...
<div class="cspacer">
		...
		<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">CHANUA BIZ(Query History)</p>
        <br />
  
        <form name='history_list' action='RLNM_History.php' method='post'>
        <center>
        ...
        ?>
                        ...
                        <?php
								$tables = array("VW_RLNM_HISTORY");
                                $columns = array("ID","MSISDN","TRANSACTION_TYPE","EVENT","MESSAGE","EVENT_DATE");
								$titles = array("ID","MSISDN","TRANSACTION TYPE","EVENT","MESSAGE","EVENT DATE");

...
<div class="cspacer">
		...
		<br />
        <p style="font:Arial, Helvetica, sans-serif; font-size:12px; color:#FF3300; padding: 5px;">MPESA TU Promo Participant Details</p>
        <br />
        ...
        ?>
                        ...
                        <?php
                                $tables = array("LNM_CVM.tbl_mtp_subscribers");
                                $columns = array("msisdn", "to_char(join_date, 'dd-MON-yyyy hh24:mi')","to_char(last_update, 'dd-MON-yyyy hh24:mi')","registration_channel");
                $titles = array("MSISDN", "Join Date", "Last Update","Registration Channel");
